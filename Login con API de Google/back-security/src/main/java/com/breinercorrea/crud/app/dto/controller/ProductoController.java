package com.breinercorrea.crud.app.dto.controller;
...
import com.breinercorrea.crud.app.dto.ProductoDto;
import com.breinercorrea.crud.app.entity.Producto;
import com.breinercorrea.crud.app.services.ProductoService;
...
public class ProductoController {
    ...
    public ResponseEntity<?> create(@RequestBody ProductoDto productoDto){
        ...
        if(productoDto.getPrecio()==null || productoDto.getPrecio()<0 )
            return new ResponseEntity<Mensaje>(new Mensaje("el precio debe ser mayor que 0"), HttpStatus.BAD_REQUEST);
        if(productoService.existsByNombre(productoDto.getNombre()))
            return new ResponseEntity<Mensaje>(new Mensaje("ese nombre ya existe"), HttpStatus.BAD_REQUEST);
        Producto producto = new Producto(productoDto.getNombre(), productoDto.getPrecio());
        productoService.save(producto);
        return new ResponseEntity<Mensaje>(new Mensaje("producto creado"), HttpStatus.OK);
    }
